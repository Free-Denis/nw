...
urlpatterns = [
    ...
    # Semantic reviewer (eval on ground-truth)
    path('review/run/', views_ai.review_run, name='review_run'),
    path('review/progress/', views_ai.review_progress, name='review_progress'),
    path('review/cancel/', views_ai.review_cancel, name='review_cancel'),
    # Audit hypotheses
